import fs from 'fs';
import type { ResponseLike } from 'strezless-musick-nexus-metadata/internal/to-file';
import { toFile } from 'strezless-musick-nexus-metadata/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('strezless-musick-nexus-metadata/core/uploads');
    await expect(
